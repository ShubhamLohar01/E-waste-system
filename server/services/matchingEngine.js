...
export class MatchingEngine {
   ...
   */
  static matchDemand(demand, recyclerId) {
   ...
   */
  static createDeliveryTask(demand, pickupHubId, deliveryWorkerId) {
   ...
   */
  static autoMatchAllDemands(deliveryWorkerPool) {
