 ...
 */
router.post('/intent', verifyAuth, requireRole('bulk_generator'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/intent/:id', verifyAuth, requireRole('bulk_generator'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/certificates', verifyAuth, requireRole('bulk_generator'), (req: AuthRequest, res: Response) => {
  try {
