 ...
 */
router.post('/', verifyAuth, requireRole('recycler'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/', verifyAuth, requireRole('recycler'), (req: AuthRequest, res: Response) => {
  try {
 ...
 * Get specific demand
 */
router.get('/:id', verifyAuth, requireRole('recycler'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.post('/:id/confirm', verifyAuth, requireRole('recycler'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/:id/deliveries', verifyAuth, requireRole('recycler'), (req: AuthRequest, res: Response) => {
  try {
    const demand = demands.find(d => d._id === req.params.id);
