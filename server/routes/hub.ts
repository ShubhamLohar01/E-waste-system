 ...
 */
router.get('/incoming', verifyAuth, requireRole('hub'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.post('/verify', verifyAuth, requireRole('hub'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/inventory', verifyAuth, requireRole('hub'), (req: AuthRequest, res: Response) => {
  try {
    ...
    const grouped: Record<string, typeof verifiedItems> = {};
 ...
 * Flag discrepancies
 */
router.post('/flag', verifyAuth, requireRole('hub'), (req: AuthRequest, res: Response) => {
  try {
