 ...
 */
router.get('/pending', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 * Collector self-assigns to a submitted intent → status becomes 'assigned'
 */
router.post('/accept', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/assignments', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.post('/collect', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.post('/hub-delivery', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/hubs', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
    const hubs = users
 ...
 */
router.get('/routes', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/history', verifyAuth, requireRole('local_collector'), (req: AuthRequest, res: Response) => {
  try {
