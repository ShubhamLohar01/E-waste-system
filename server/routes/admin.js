 ...
 */
router.get('/config', verifyAuth, requireRole('admin'), (req, res) => {
  try {
    res.json({
      config: {
        matching: {
 ...
 */
router.put('/config', verifyAuth, requireRole('admin'), (req, res) => {
  try {
 ...
 */
router.post('/match', verifyAuth, requireRole('admin'), (req, res) => {
  try {
